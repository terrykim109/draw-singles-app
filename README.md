...
**Frontend preview:** Vercel-hosted frontend only; the Python/ML backend is too large for available free hosting limits, so full functionality requires running it locally.
